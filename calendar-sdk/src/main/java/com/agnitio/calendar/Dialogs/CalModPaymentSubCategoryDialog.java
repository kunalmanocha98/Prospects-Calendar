...
public class CalModPaymentSubCategoryDialog extends Dialog implements CalModOnDataSelectListener {
    ...
    public CalModPaymentSubCategoryDialog(@NonNull Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<String> categories = Arrays.asList(context.getResources().getStringArray(R.array.expense_sub_categories));
