...
import com.agnitio.prospectscalendar.Dialogs.CalModCustomDialog;
import com.agnitio.prospectscalendar.R;
import com.agnitio.prospectscalendar.activities.CalModActivityAddEvent;
...
//        mCalModCellEvents.add(new CalModCellEvent("Hello", date));
